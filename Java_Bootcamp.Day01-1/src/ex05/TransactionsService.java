...
public class TransactionsService {
    ...
    public Transaction removeTransaction(User user, UUID idTrascation) {
        return usersList.getUserById(user.getIdentifier()).getTransactionsList().removeTransactionById(idTrascation);
    }
