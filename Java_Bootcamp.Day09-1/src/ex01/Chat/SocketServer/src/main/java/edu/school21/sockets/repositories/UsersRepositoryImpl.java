...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    public void save(User entity) {
        ...
        String query = "INSERT INTO chat.user (email, \"password\") VALUES(?, ?)";
        int affectedRows = this.dataSource.update(query, new Object[]{entity.getEmail(), entity.getPassword()});
        if (affectedRows != 1)
    ...
    public void update(User entity) {
        ...
        String query = "UPDATE chat.user SET email = ?, \"password\" = ? WHERE id = ?";
        int affectedRows = this.dataSource.update(query, new Object[]{entity.getEmail(), entity.getPassword(), entity.getId()});
        if (affectedRows != 1)
